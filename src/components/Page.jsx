    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto">
        ...
        <div className="flex justify-between mt-4 gap-8">
          <button
            className="fill-hover bg-gray-300 text-gray-700 py-1 px-3 rounded"
            onClick={handleViewCart}
          ><span>
            View Cart</span>
          </button>
          <button
            className="fill-hover bg-gray-700 text-white py-1 px-3 rounded"
        ...
        <button
          className="fill-hover bg-gray-700 text-white py-2 w-full rounded-full mt-4"
          onClick={onClose}
        ><span>
